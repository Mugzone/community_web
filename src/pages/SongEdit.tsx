  ...
  const handleCoverUpload = async () => {
    ...
    try {
      ...
      if (sign.code !== 0 || !sign.url || !sign.meta) {
        ...
        setCoverError(
          mod === 5
            ? t("song.edit.error.permission")
            : t("song.edit.cover.error")
        );
        return;
      }
          ...
          <div className="song-editor">
            ...
            <div className="song-editor-card song-cover-card">
              ...
              <label className="song-file-input">
                ...
                />
                <span>
                  {coverFile ? coverFile.name : t("song.edit.cover.select")}
                </span>
              </label>
              ...
              <div className="song-editor-actions">
                ...
                >
                  {coverUploading
                    ? t("song.edit.cover.uploading")
                    : t("song.edit.cover.upload")}
                </button>
              </div>
            </div>
          </div>
