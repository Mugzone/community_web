...
export const renderTemplateHtml = (t: TranslateFn, tmpl: WikiTemplate, resp: RespWikiTemplate) => {
  if (resp.message) {
...
export const applyTemplateHtml = (html: string, templateBlocks: Array<string | undefined>) => {
